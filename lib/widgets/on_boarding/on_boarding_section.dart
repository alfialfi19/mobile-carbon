...
class OnBoardingSection extends StatelessWidget {
  ...
  final VoidCallback? swipeNextCallback;
  final VoidCallback? swipePrevCallback;
  ...
  const OnBoardingSection({
    ...
    this.swipeNextCallback,
    this.swipePrevCallback,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GestureDetector(
        onPanUpdate: (details) {
          // Swiping in right direction or previous.
          if (details.delta.dx > 0) {
            swipePrevCallback?.call();
          }

          // Swiping in left direction or next.
          if (details.delta.dx < 0) {
            swipeNextCallback?.call();
          }
        },
        child: Stack(
          children: [
