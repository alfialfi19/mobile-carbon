                          ...
                          child: ListView(
                            ...
                            children: [
                              PointOwned(
                                ...
                                pointValue: int.parse(data.totalPoint1 ?? "0"),
                              ...
                              PointOwned(
                                ...
                                pointValue: int.parse(data.totalPoint2 ?? "0"),
                              ...
                              PointOwned(
                                ...
                                pointValue: int.parse(data.totalPoint3 ?? "0"),
                                colorGradient: const LinearGradient(
                                  begin: Alignment.bottomLeft,
                                  end: Alignment.topRight,
                                  colors: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color:
                                          ColorPalettes.white.withOpacity(0.2),
                                    ),
                                    child: Text(
